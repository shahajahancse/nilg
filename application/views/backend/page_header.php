            ...
            <ul class="pull-left">
               <?php 
                     ...
                     */ 
                        ...
                        <li class="start <?= backend_activate_menu_class('trainee') ?>">
                           ...
                           <li class="start <?= backend_activate_menu_class('trainer') ?>">
                              <a href="javascript:;"> <i class="fa fa-user"></i> <span class="title">প্রশিক্ষক</span> <span class="selected"></span>
                                 <?php
                                 /*if ($request_trainer_no > 0) {
                                    echo '<span class="badge badge-danger pull-right">' . eng2bng($request_trainer_no) . '</span>';
                                 }*/
                                 ?>
                                 <span class="arrow"></span> </a>
                                 <ul class="sub-menu">
                                    ...
                                    <!-- <li> <a href="<?= base_url('trainer/request'); ?>"> প্রশিক্ষকের আবেদন
                                       <?php
                                       /*if ($request_trainer_no > 0) {
                                          echo '<span class="badge badge-danger pull-right">' . eng2bng($request_trainer_no) . '</span>';
                                       }*/
                     ...
                     <?php $people = array("sk", "jd", "dg");?>
                     <?php //echo $userDetails->crrnt_desig_id; exit; ?>

                     <?php if(!$this->ion_auth->in_group(array('nilg'))){
                        if ($this->ion_auth->in_group(array('admin')) || (func_nilg_auth($userDetails->office_type) == 'employee') || in_array(func_nilg_auth($userDetails->office_type, $userDetails->crrnt_desig_id), $people)) { ?>
                           <li class="start <?= backend_activate_menu_class('inventory') ?>">
                              <a href="javascript:;"> <i class="fa fa-user"></i> <span class="title">ইনভেন্টরি</span> <span class="selected"></span>
                                 <?php
                                 ...
                                 <?php if ($this->ion_auth->in_group(array('admin','sm','asm'))) { ?>
                                    ...
                                    <li class="start <?= backend_activate_menu_method('pending_list') ?>">
                                       ...
                                       <?php if ($request_stor_no['pending'] > 0) {
                                          echo '<span class="badge badge-danger pull-right">' . $request_stor_no['pending'] . '</span>';
                                       } ?> 
                                       </a>
                                    </li>
                                    ...
                                    <li>
                                       ...
                                       <?php if ($request_stor_no['approve'] > 0) {
                                          echo '<span class="badge badge-danger pull-right">' . $request_stor_no['approve'] . '</span>';
                                          } ?>
                                       </a>
                                    </li>
                                    ...
                                    <li>
                                       ...
                                       <?php if ($request_stor_no['reject'] > 0) {
                                          echo '<span class="badge badge-danger pull-right">' . $request_stor_no['reject'] . '</span>';
                                       } ?>
                                       </a>
                                    </li>
               ...
               <div class="footer-widget">
                  ...
                  <div class="pull-right">
                     <a href="http://www.mysoftheaven.com/" target="_blank">
                        <img src="<?php echo base_url('awedget/assets/img/mysoft-logo.png') ?>" height="30"></a>
                     </div>
                  </div>
                  <!-- END SIDEBAR -->
