...
<div class="page-content">
        ...
        <div class="grid simple horizontal red">
          ...
          <div class="grid-body">
            ...
            <div class="row">
              ...
              echo form_open_multipart("trainee/add_pr", $attributes); ?>
              ...
              <div id="rootprwizard">
                <div class="form-wizard-steps">
                  <ul class="wizard-steps">
                    ...
                    <li data-target="#step2" class=""> <a href="#tab2" data-toggle="tab"> <span class="step">২</span> <span class="title"><strong>দায়িত্ব প্রাপ্ত প্রতিষ্ঠানের তথ্য</strong></span> </a> </li>
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="tab1">
                    <div class="row" style="margin-bottom: 0px;">
                      <div class="col-md-12">
                        ...
                        <div class="row form-row">
                          <div class="col-md-3">
                            <div class="form-group">
                              ...
                              <input name="nid" id="nid" type="number" value="<?= set_value('nid') ?>" class="form-control input-sm font-opensans" placeholder="1XXXXXXXXX" contenteditable="off">
                            </div>
                          </div>
                          <div class="col-md-3">
                            <div class="form-group">
                        ...
                        <div class="row form-row">
                          <div class="col-md-3">
                            <div class="form-group">
                              ...
                              <input name="dob" type="text" value="<?= set_value('dob') ?>" class="datetime form-control input-sm font-opensans">
                            </div>
                          </div>
                          <div class="col-md-3">
                        ...
                        <div class="row form-row">
                          ...
                          <?php /* if ($this->ion_auth->in_group('nilg')) { ?>
                            <div class="col-md-2">
                              <div class="form-group">
                    ...
                    <div class="tab-pane" id="tab2">
                      <?php
                      if(!($this->ion_auth->is_admin() || $this->ion_auth->in_group('nilg'))){ 
                        $this->load->view('pr_official_add_form');
                      }else{
                        $this->load->view('pr_official_add_form_nilg');
                      } 
                      ?>
                    </div>                  
  ...
  $("#addRowExperience").click(function(e) {
    ...
    items += '<td><input name="exp_duration[]" type="text" class="form-control input-sm" placeholder="৫ বছর"></td>';
