        ...
        <div class="grid simple horizontal red">
          ...
          <div class="grid-body">
            ...
            <div class="row form-row">
              ...
              <div class="col-md-4">
                <label class="form-label font-opensans">New Password (Min. 8 characters) <span class="required">*</span></label>
                <?php echo form_error('new'); ?>
                <?php echo form_input($new_password);?>
              </div>
              <div class="col-md-4">
                <label class="form-label font-opensans">Confirm New Password <span class="required">*</span></label>
 ...
 $(document).ready(function() {
  $('#validate').validate({
      ...
      rules: {
        ...
        new_confirm: { required: true, equalTo: "#new" }
      },
