            ...
            <div class="col-md-12">
                <div class="grid simple horizontal red">
                    ...
                    <div class="grid-body">
                        ...
                        echo form_open_multipart("trainee/edit_trainee_general_info/". encrypt_url($info->id) , $attributes); ?>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <?php if($this->ion_auth->is_admin()){ ?>
                                                                ...
                                                                <input name="nid" type="text" value="<?= set_value('nid', $info->nid) ?>" class="form-control input-sm" placeholder="">
                                                            <?php } else { ?>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <?php if($this->ion_auth->is_admin()){ ?>
                                                                ...
                                                                <input name="mobile_no" type="text" value="<?= set_value('mobile_no', $info->mobile_no) ?>" class="form-control input-sm" placeholder="">
                                                            <?php } else { ?>
                                                                <span class="font-big-bold"><?= eng2bng($info->mobile_no) ?></span>
                                                            <?php } ?>
                                                        </div>
                                                ...
                                                <div class="row form-row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="name_en" type="text" value="<?= set_value('name_en', $info->name_en) ?>" class="form-control input-sm font-opensans" onkeyup="upperCase()" placeholder="e.g. ATAUL MOSTAFA" style="text-transform: uppercase;">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                ...
                                                <div class="row form-row">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="email" type="text" value="<?=$info->email ?>" class="form-control input-sm" placeholder="sakil102@gmail.com">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
