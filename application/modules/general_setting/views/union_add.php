  ...
  <div class="content">  
    ...
    <div class="col-md-10">
      ...
      <div class="grid-body">
        ...
        echo form_open_multipart(base_url()."general_setting/union_add",$attributes); ?>
     ...
     <div class="row form-row">
      <div class="col-md-6">
        ...
        <input name="uni_name_bn" type="text" value="<?=set_value('uni_name_bn')?>"  class="form-control input-sm" placeholder="উদাহরণ: মোহাম্মদপুর">
      </div>
      <div class="col-md-6">                  
        <label class="form-label">Union Name (English)</label>
        <?php echo form_error('uni_name_en'); ?>
        <input name="uni_name_en" type="text" value="<?=set_value('uni_name_en')?>" class="form-control input-sm" placeholder="e.g. Mohammadpur">
      </div>
    </div>
