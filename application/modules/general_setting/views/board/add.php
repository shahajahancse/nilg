      ...
      <div class="col-md-12">
        <div class="grid simple horizontal red">
          ...
          <div class="grid-body">
            ...
            echo form_open_multipart("general_setting/board_add", $attributes);
            ?>
            ...
            <div class="row form-row">            
              <div class="col-md-6">
                ...
                <input name="board_institute_name" type="text" value="<?=set_value('board_institute_name')?>" class="form-control input-sm" placeholder="" >
              </div>
            </div>
