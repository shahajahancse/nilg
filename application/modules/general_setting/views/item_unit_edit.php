         ...
         <div class="col-md-8">
            <div class="grid simple horizontal red">
               ...
               <div class="grid-body">
                  ...
                  echo form_open_multipart("general_setting/item_unit_edit/$rows->id", $attributes);?>

                  <div class="row form-row">
                     <div class="col-md-6">
                        <label class="form-label"> ইউনিট নাম </label>
                        <?php echo form_error('unit_name'); ?>
                        <input name="unit_name" type="text" value="<?=$rows->unit_name?>" class="form-control input-sm" placeholder="">
                     </div>
