        ...
        <div class="grid simple horizontal green">
          <div class="grid-title">
            ...
            <div class="pull-right">
              <a href="<?=base_url('general_setting/exam_add')?>" class="btn btn-primary btn-xs btn-mini"> এন্ট্রি করুন</a>
            </div>            
          </div>
              ...
              <tbody>
                ...
                foreach ($results as $row){
                  ...
                  <tr>
                    ...
                    <td><?=$status?></span></td>
                    <td>
                      <a href="<?=base_url('general_setting/exam_edit/'.$row->id)?>" class="btn btn-mini btn-primary">সংশোধন</a>
                      <?php /*
                      <div class="btn-group">
