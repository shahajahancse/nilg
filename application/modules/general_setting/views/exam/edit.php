        ...
        <div class="grid simple horizontal red">
          ...
          <div class="grid-body">
            ...
            <div class="row form-row">            
              <div class="col-md-6">
                <label class="form-label"> পরীক্ষার নাম নাম <span class="required">*</span></label>
                <?php echo form_error('exam_name'); ?>
                <input name="exam_name" type="text" value="<?=set_value('exam_name', $info->exam_name)?>" class="form-control input-sm" placeholder="" >
              </div>
