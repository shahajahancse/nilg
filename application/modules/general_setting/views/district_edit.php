          ...
          <div class="grid-body">
            ...
            <div class="row form-row">
              <div class="col-md-6">
                ...
                <?php echo form_dropdown('division', $division, $info->dis_div_id, 'id="division" class=" form-control input-sm"');?>
              </div>
              <div class="col-md-6">
            ...
            <div class="row form-row">
              <div class="col-md-6">
                ...
                <input name="dis_name_bn" id="dis_name_bn" type="text" value="<?=set_value('dis_name_bn', $info->dis_name_bn)?>" class="form-control input-sm" placeholder="উদাহরণ: ঢাকা">
              </div>
              <div class="col-md-6">
                <label class="form-label">District Name (English)</label>
                <?php echo form_error('dis_name_en'); ?>
                <input name="dis_name_en" id="dis_name_en" type="text" value="<?=set_value('dis_name_en', $info->dis_name_en)?>" class="form-control input-sm" placeholder="e.g. Dhaka">
              </div>
            </div>
            ...
            <div class="row form-row">
              <div class="col-md-6">
                ...
                <input name="district_geo" type="number" value="<?=set_value('district_geo', $info->dis_bbs_code)?>" class="form-control input-sm" placeholder="e.g. 10">
              </div> 
            </div>
