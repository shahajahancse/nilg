...
<div class="page-content">
    ...
    <?php 
      ...
      ');
      $total_amount_ay = $this->db->get('budget_j_publication_register')->row();
    ...
    ?>
        <div class="row">
            <div class="col-md-12">
                <h1 style="text-align: center; color: #333;">স্বাগতম, এনআইএলজি (এমআইএস) | জাতীয় স্থানীয় সরকার ইনস্টিটিউট</h1>
        ...
        <div class="col-md-4">
                <div class="panel panel-default text-center"
                    ...
                    <div class="panel-body">
                        <h3 style="color: #53d769; font-weight: bold; font-size: 36px; margin-bottom: 10px;" id="incomeCounter">৳ <?=($total_amount_ay->total_amount!='')?eng2bng($total_amount_ay->total_amount):'০.০০'?></h3>
            ...
            <div class="col-md-4">
                <div class="panel panel-default text-center"
                    style="box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2); transition: 0.3s; border: none; border-radius: 10px; background-color: #fff; padding: 20px;">
                    <div class="panel-body">
                        <h3 style="color: #ff6f61; font-weight: bold; font-size: 36px; margin-bottom: 10px;" id="expenseCounter">৳ <?=($total_amount->total_amount!='')?eng2bng($total_amount->total_amount):'০.০০'?></h3>
            ...
            <div class="col-md-4">
                <div class="panel panel-default text-center"
                    style="box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2); transition: 0.3s; border: none; border-radius: 10px; background-color: #fff; padding: 20px;">
                    <div class="panel-body">
                        <h3 style="color: #4a90e2; font-weight: bold; font-size: 36px; margin-bottom: 10px;" id="entryCounter"><?=($total_amount_ay->count!='')?eng2bng($total_amount_ay->count):'০.০০'?></h3>
                        <h4 style="color: #555; font-size: 20px; margin-bottom: 0;">মোট প্রকাশনা রেজিস্টার এন্ট্রি</h4>
                    </div>
                </div>
            </div>
        </div>
