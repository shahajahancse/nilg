			...
			<table class="table table-hover table-bordered report">
				<thead class="headding">
					<tr>
						...
						<td class="text-left">পৌরসভার নাম</td>
						<td class="text-left">পৌরসভা পরিষদ</td>
				...
				<tbody>
					...
					foreach ($result_data as $key => $row) { 
						$sub = ($row->count != NULL)? $row->count:0;
					...
					<tr>
						...
						<td class="text-right"><?=eng2bng($sub)?></td>
					</tr>
					<?php } ?>
				</tbody>
				...
				<tfoot class="headding">
					<tr>
						<td class="text-right" colspan="3">সর্বমোটঃ</td>
