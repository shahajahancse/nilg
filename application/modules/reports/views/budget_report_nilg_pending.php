		...
		<div class="priview-demand">
			...
			<thead class="headding">
					<tr>
						...
						<td class="text-left">শিরোনাম</td>
						<td class="text-right">পরিমাণ</td>
						<td class="text-right">ডিপার্টমেন্ট পরিমাণ</td>
						<td class="text-right">আকাউন্ট পরিমাণ</td>
						<td class="text-right">ডি জি পরিমাণ</td>
						<td class="text-right">অর্থ বছর</td>
						<td class="text-right">ডিপার্টমেন্ট</td>
					</tr>
				</thead>
				...
				<tbody>
					...
					<tr>
						...
						<td class="text-right"><?= $row->dpt_amt ?></td> 
						<td class="text-right"><?= $row->acc_amt ?></td> 
						<td class="text-right"><?= $row->dg_amt ?></td> 
						<td class="text-right"><?= $row->session_name ?></td>
						<td class="text-right"><?= $row->dept_name?></td>
					</tr>
					<?php $i++; } ?>
				</tbody>
			</table>			
