            ...
            <table class="" style="width: 100%;" border="1" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-right"><?= eng2bng($row->amount)?></td>
                        <td class="text-right"><?= eng2bng($row->dpt_amt) ?></td>
                        <td class="text-right"><?= eng2bng($row->acc_amt) ?></td>
                        <td class="text-right"><?= eng2bng($row->dg_amt)?></td>
                        <td class="text-right"><?= eng2bng($row->session_name) ?></td>
