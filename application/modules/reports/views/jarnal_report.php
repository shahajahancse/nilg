<?php
// dd('jkbdfffffffffffffffffffffkjffffffffffffffffffffffffff')
?>
        ...
        <div class="priview-demand">
            <table class="" style="width: 100%;" border="1" cellspacing="0">
                <thead class="headding">
                    <tr>
                        <!-- id	voucher_no	amount	type 1=cash in, 2=cash out	status	reference	description	date	created_at	create_by -->
                        <th class="text-center">নং</th>
                        <th class="text-left">ভাউচার নং</th>
                        <th>পরিমাণ</th>
                        <th>টাইপ</th>
                        <th>তারিখঃ</th>
                    </tr>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?= ($row->type) ? 'ক্যাশ ইন' : 'ক্যাশ আউট' ?></td>
                            <td>
                                <?= isset($row->date) ? date_bangla_calender_format($row->date) : date_bangla_calender_format($row->issue_date) ?>
                            </td>
                        </tr>
                    <?php $i++;
                    } ?>
