            ...
            <div class="row">
              ...
              <div class="col-md-12 table-responsive">
                <table class="tg" width="100%">
                          ...
                          <table>
                            ...
                            <?php foreach ($promotion as $exp) { ?>
                              <tr>
                                ...
                                <td><?= $exp->pro_org_name; ?></td>
                                <td><?= $exp->promo_salary_ratio; ?></td>
                  ...
                  <tr>
                    <td class="tg-mtwr" colspan="4"> এনআইএলজি থেকে প্রাপ্ত প্রশিক্ষ্ণ </td>
                  </tr>
                  <tr>
                    <td class="tg-ywa9" colspan="4">
                  ...
                  <tr>
                    <td class="tg-mtwr" colspan="4"> দেশে অন্যান্য প্রতিষ্ঠান থেকে প্রাপ্ত প্রশিক্ষ্ণ </td>
                  </tr>
                  <tr>
                    <td class="tg-ywa9" colspan="4">
                  ...
                  <tr>
                    <td class="tg-mtwr" colspan="4"> বিদেশ থেকে প্রাপ্ত প্রশিক্ষ্ণ </td>
                  </tr>
                  <tr>
                    <td class="tg-ywa9" colspan="4">
