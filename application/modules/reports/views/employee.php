              ...
              <div class="col-md-8">
                ...
                <div class="row form-row">
                  <div class="col-md-12" style="text-align: center; border:1px solid #0aa699; padding:10px 5px 20px 5px; position: relative; margin-top: 40px">
                    ...
                    <button type="submit" name="btnsubmit" value="pdf_untrained_list" onclick="return validFunc6()" class="btn btn-info btn-cons margin-top"> অপ্রশিক্ষিত ব্যক্তির রিপোর্ট</button>
                    <button type="submit" name="btnsubmit" value="pdf_trained_list" onclick="return validFunc6()" class="btn btn-info btn-cons margin-top"> প্রশিক্ষিত ব্যক্তির রিপোর্ট</button>
                  </div>
                </div>
              </div> <!-- /col-md-8 -->
