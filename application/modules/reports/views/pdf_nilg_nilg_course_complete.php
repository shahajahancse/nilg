		...
		<div class="priview-memorandum">
			<div class="row">
				<div class="col-12 text-left">
					<div style="font-size:18px;"><u>কোর্সের নাম:</u> <?=$course_info->course_title?></div>
			...
			<table class="table table-hover table-bordered report">
				<thead class="headding">
					<tr>
						...
						<th class="text-center">ন্যাশনাল আইডি নম্বর</th>
