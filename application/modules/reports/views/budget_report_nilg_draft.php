            ...
            <table class="" style="width: 100%;" border="1" cellspacing="0">
                <thead class="headding">
                    <tr>
                        ...
                        <th class="">পরিমাণ</th>
                        <th class="">ডিপার্টমেন্ট পরিমাণ</th>
                        <th class="">আকাউন্ট পরিমাণ</th>
                        <th class="">ডি জি পরিমাণ</th>
                        <th class="">অর্থ বছর</th>
                        <th class="">ডিপার্টমেন্ট</th>
                    </tr>
                </thead>
                <tbody>
                    <?php					
                    ...
                    <tr>
                        ...
                        <td class=""><?= eng2bng($row->dpt_amt)?></td>
                        <td class=""><?= eng2bng($row->acc_amt) ?></td>
                        <td class=""><?= eng2bng($row->dg_amt) ?></td>
