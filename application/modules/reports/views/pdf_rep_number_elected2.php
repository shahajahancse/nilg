			...
			<table class="table table-hover table-bordered report">
				<thead class="headding">
					<tr>
						...
						<th class="text-center" width="300">নির্বাচনের সংখ্যা</th>
						<th class="text-center" width="300">সংখ্যা</th>
					</tr>
				</thead>
				...
				<tbody>
					...
					foreach ($results as $key => $value) { 
						...
						<tr>
							...
							<td class="text-center"><?=eng2bng($key)?></td>
							<td class="text-center"><?=eng2bng($value)?></td>
						</tr>
						<?php } ?>
					</tbody>
