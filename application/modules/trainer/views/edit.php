                      ...
                      <div class="col-md-4">
                        <div class="row form-row">
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <?php if($this->ion_auth->in_group('uzp') || $this->ion_auth->in_group('paora') || $this->ion_auth->in_group('up')){ ?>
                        ...
                        <div class="row form-row addDiv" style="<?=$address_dis?>">
                          <div class="col-md-6">
                            <div class="form-group">
                              <label class="form-label">বিভাগঃ</label>
                              <?php if($this->ion_auth->in_group('city') || $this->ion_auth->in_group('zp') || $this->ion_auth->in_group('uzp') || $this->ion_auth->in_group('paora') || $this->ion_auth->in_group('up')){ ?>
                          ...
                          <div class="col-md-6" id="unionDiv" style="<?=$display_union?>">
                            <?php if(!$this->ion_auth->in_group('paora') && !$this->ion_auth->in_group('uzp')){ ?>
                            <div class="form-group">
