                ...
                <div class="row">
                  <div class="col-md-6">
                      <p><i class="fa fa-envelope"></i>Join Date<br> 
                        <span class="info"><?=$join_date?></span> </p>
                  </div>
                  <div class="col-md-6">
                ...
                <div class="row">
                  <div class="col-md-6">
                      ...
                      <p><i class="fa fa-file-o"></i><?=lang('my_profile_phone');?> <br>
                        <span class="info"><?=$phone?></span> </p>
                      <p><i class="fa fa-globe"></i>Email <br>
                        <span class="info"><?=$email?></span> </p>
                      <p><i class="fa fa-envelope"></i>Join Date<br> 
                        <span class="info"><?=$join_date?></span> </p>
                      <p><i class="fa fa-envelope"></i>Last Login<br> 
                        <span class="info"><?=$last_update?></span> </p>
                  ...
                  <div class="col-md-6">
                      <p><i class="fa fa-globe"></i> <?=lang('my_profile_present_address');?><br>
                        <span class="info"><?=$info->present_add?></span> </p>
                      <p><i class="fa fa-globe"></i> <?=lang('my_profile_permanent_address');?><br>
                        <span class="info"><?=$info->permanent_add?></span> </p>
                  </div>
                </div>
                <?php } ?>
...
.tg td{font-family:Arial, sans-serif;font-size:14px;padding:8px 5px;border-style:solid;border-width:1px;overflow:hidden;word-break:normal;border-color:#bbb;color:#594F4F;background-color:#E0FFEB; vertical-align: middle;}
...
.tg .tg-khup{background-color:#efefef;color:#ffffff;vertical-align:top; width: 200px; color: black; text-align: left;}
