				...
				<div class="grid simple horizontal red">
					<div class="grid-title">
						...
						<div class="pull-right">
							<a href="<?=base_url('my_profile')?>" class="btn btn-primary btn-xs btn-mini"> sssকর্মকর্তা / কর্মচারীর তালিকা </a>
					...
					<div class="grid-body table-responsive">
							...
							<div class="col-md-12">
								...
								<table class="tg" width="100%">
									...
									<tr>
										...
										<td class="tg-ywa10"><?=$info->present_add?></td>
									</tr>
									<tr>
						...
						<div class="row mb-50">
							<div class="col-md-12">
								...
								<div class="pull-right">
									<a href="<?= base_url('my_profile/edit_employee_official/' . encrypt_url($info->id)) ?>" class="btn btn-blueviolet btn-xs btn-mini"> সম্পাদন করুন </a>
								</div>
								...
								<table class="tg" width="100%">
									...
									<tr>
									<tr>
										<td class="tg-khups">বর্তমান চাকুরীতে দ্বায়িত্বপ্রাপ্ত বিভাগঃ</td>
									...
									<tr>
										...
										<td class="tg-ywa9" colspan="3">
											...
											<table style="border-collapse:collapse; border:1px solid #ccc;width: 100%;">
												...
												<tr> <td><?=$exp->office_name;?></td> <td><?=$exp->desig_name;?></td> <td><?=$exp->exp_duration;?></td> </tr>
												<?php } ?>
											</table>
											<?php } ?>
										</td>
						...
						<div class="row mb-50">
							<div class="col-md-12">
								...
								<div class="pull-right">
									<a href="<?= base_url('my_profile/edit_trainee_promotion/' . encrypt_url($info->id)) ?>" class="btn btn-blueviolet btn-xs btn-mini"> সম্পাদন করুন </a>
								</div>
