                            ...
                            <table width="100%" border="1" id="nilgTrainingDiv">
                                ...
                                <?php if (!empty($nilg_training)) {
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" class="form-control input-sm datetime" value="<?=$row->start_date?>" name="start_date[]"></td>
                                        <td><input type="text" class="form-control input-sm datetime" value="<?=$row->end_date?>" name="end_date[]"></td>
