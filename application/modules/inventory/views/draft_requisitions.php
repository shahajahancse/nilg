               ...
               <div class="grid-body">
                                 ...
                                 <div class="col-md-12" >
                                    ...
                                    <table width="100%" border="1" id="appRowDiv" style="border:1px solid #a09e9e;">
                                       ...
                                       <tr>
                                          ...
                                          <td> 
                                             <a data-id="<?=$row->id?>" onclick="removeRowRequisitionFunc(this)" class="label label-important" style="cursor: pointer; "> <i class="fa fa-minus-circle"></i> মুছে ফেলুন</a>
                                          </td>
                                       </tr>
                                       <?php } } ?>
                                    </table>
                  ...
                  <div class="form-actions">  
                     <div class="pull-right"> 
                        ...
                        <!-- <input type="submit" name="submit" value="ফরওয়ার্ড স্টোর কীপার" class="btn btn-primary btn-sm"> -->
                     </div>
                  </div>
                  <?php echo form_close();?>
