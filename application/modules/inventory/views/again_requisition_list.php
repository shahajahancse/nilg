            ...
            <div class="grid simple ">
               <div class="grid-title">
                  ...
                  <div class="pull-right">                
                     <a href="<?=base_url('inventory/index')?>" class="btn btn-blueviolet btn-xs btn-mini">ফিরে যান</a>  
                  </div>
               </div>
                     ...
                     <tbody>
                        ...
                        foreach ($results as $row) {
                           ...
                           <tr>
                              ...
                              <td class="v-align-middle"><?=anchor("inventory/again_requisition_create/".encrypt_url($row->id), 'পুনরায় রিকুইজিশন', array('class' => 'btn btn-primary btn-mini'))?></td>
                           </tr>
                        <?php } ?>
                     </tbody>
                  </table>
