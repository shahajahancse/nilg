         ...
         <div class="col-md-12">
            <div class="grid simple ">
               ...
               <div class="grid-body table-responsive">
                                 ...
                                 <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                       ...
                                       <?php if ($this->ion_auth->in_group(array('admin', 'sm', 'asm'))) { ?>
                                          <li><a href="<?php echo base_url('inventory/change_requisition_status/' . encrypt_url($row->id)) ?>"><i class="fa fa-user"></i> রিকুয়েস্ট অ্যাপ্রোভ </a></li>
                                       <?php } ?>
                  ...
                  <div class="row">
                     <div class="col-sm-4 col-md-4 text-left" style="margin-top: 20px;"> সর্বমোট <span style="color: green; font-weight: bold;"><?php echo eng2bng($total_rows); ?> পেন্ডিং রিকুইজিশন </span></div>
