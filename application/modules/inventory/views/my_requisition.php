                                 ...
                                 <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                       ...
                                       <?php if ($row->current_desk == 5 && $row->status == 6) { ?>
                                          <li><a id="modalId" data-toggle="modal" data-target="#myModal" data-id="<?= encrypt_url($row->id) ?>" href="<?php //echo base_url('inventory/forword_store_kipar/'.encrypt_url($row->id))
                                                                                                                                                      ?>"><i class="fa fa-user"></i>ফরওয়ার্ড স্টোর কীপার </a></li>
