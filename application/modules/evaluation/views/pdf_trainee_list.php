		...
		<div class="priview-demand">
			<table class="table table-hover table-bordered report">
				<thead class="headding">
					<tr>
						<td class="text-center" width="100"><strong>ক্রম</strong> </td>
						<td class="text-center" width="120"><strong>প্রশিক্ষণার্থীর নাম</strong> </td>
						<td class="text-center" width="50"><strong>এনআইডি</strong> </td>
						<td class="text-center"><strong>পদবি</strong> </td>
						<td class="text-left" width="180"><strong>মোবাইল নম্বর</strong> </td>
					</tr>
				</thead>
				...
				<tbody>
					...
					foreach ($results as $row) { 
						...
						<tr style="line-height: 100px;">
							...
							<td class="text-center"><?=$row->name_bn?></td>
							<td class="text-center"><?=eng2bng($row->nid)?></td>
							<td class="text-center"><?=$row->desig_name?></td>
							<td class="text-center"><?=eng2bng($row->mobile_no)?></td>
