              ...
              <div class="col-md-8">
                <div class="row form-row">
                  <div class="col-md-6">
                    ...
                    <input name="participant_name" type="text" class="form-control input-sm" placeholder="" value="<?=set_value('participant_name', $info->participant_name)?>">
                  </div>
                  ...
                  <div class="col-md-6">
                    ...
                    echo form_dropdown('course_id', $course_list, set_value('course_id', $info->course_id), $more_attr);
                    ?>
                  </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <input name="reg_start_date" type="text" class="form-control input-sm datetime" placeholder="" value="<?=set_value('reg_start_date', $info->reg_start_date)?>">                  
                  </div>
                  <div class="col-md-6">
                    <label class="form-label">রেজিঃ শেষের তারিখ <span class="required">*</span></label>
                    <?php echo form_error('reg_end_date'); ?>
                    <input name="reg_end_date" type="text" class="form-control input-sm datetime" placeholder="" value="<?=set_value('reg_end_date', $info->reg_end_date)?>">
                  </div>
                </div>
                <div class="row form-row">
                  <div class="col-md-6">
                    ...
                    <input name="cd_name" type="text" class="form-control input-sm" placeholder="" value="<?=set_value('cd_name', $info->cd_name)?>">
                    <label class="form-label">কোর্স সমন্বয়কের নাম</label>
                    <h5><?=@$main_cc->office_name?></h5>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label class="form-label">কোর্স পরিচালকের পদবি <span class="required">*</span></label>
                      <?php echo form_error('cd_designation'); ?>
                      <input name="cd_designation" type="text" class="form-control input-sm" placeholder="" value="<?=set_value('cd_designation', $info->cd_designation)?>">
                      <label class="form-label">কোর্স সমন্বয়কের পদবি</label>
                      <h5><?=@$main_cc->designation?></h5>
                    </div>
                  </div>                  
                </div>
                <div class="row" style="margin-bottom: 20px;">
                  ...
                  <div id="msgRemoveCc"> </div>
                    ...
                    <table width="100%" border="1" id="ccDiv">
                      ...
                      <tr>
                        <td><select class="coordinatorSelect2 form-control input-sm" name="coordinator_id[]" id="selected_cc_id" style="width: 100%;"></select></td>
                        <script>
                          var $newOption = $("<option></option>").val("<?php echo $row->user_id;?>").text("<?php echo $row->office_name;?>");
                          $("#selected_cc_id").append($newOption).trigger('change');
                        </script>
                        <td><?php echo $row->designation;?></td>
                        <td width="100"> <a href="javascript:void();" data-id="<?=$row->id?>" onclick="removeRowCcFunc(this)" class="label label-important"> <i class="fa fa-minus-circle"></i> মুছে ফেলুন</a> </td>
                        <input type="hidden" name="hide_cc_id[]" value="<?=$row->id?>">
                      </tr>
                      <?php } ?>  -->
                      <tr></tr>
                    </table>
              ...
              <div class="col-md-4">
                <div class="row form-row">   
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input name="batch_no" type="number" class="form-control input-sm" placeholder="" value="<?=set_value('batch_no', $info->batch_no)?>">      
                    </div>
                  </div>  
                  <div class="col-md-8">
                    <div class="form-group">
                      ...
                      $more_attr = 'class="form-control input-sm"';
                      echo form_dropdown('type_id', $training_type, set_value('type_id', $info->type_id), $more_attr);
                      ?>  
                    </div>
                  </div>              
                  <div class="col-md-6">
                    ...
                    <input name="start_date" type="text" class="form-control input-sm datetime" placeholder="" value="<?=set_value('start_date', $info->start_date)?>">                  
                  </div>
                  <div class="col-md-6">
                    <label class="form-label">শেষের তারিখ <span class="required">*</span></label>
                    <?php echo form_error('end_date'); ?>
                    <input name="end_date" type="text" class="form-control input-sm datetime" placeholder="" value="<?=set_value('end_date', $info->end_date)?>">
                  </div>
                </div>
                <div class="row form-row"> 
                  <div class="col-md-6">
                    ...
                    <input name="ta" type="number" class="form-control input-sm" placeholder="" value="<?=set_value('ta', $info->ta)?>">
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label class="form-label">ডিএ </label>
                      <?php echo form_error('da');?>
                      <input name="da" type="number" class="form-control input-sm" placeholder="" value="<?=set_value('da', $info->da)?>">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <label class="form-label">প্রশিক্ষণ ভাতা </label>
                    <?php echo form_error('tra_a'); ?>
                    <input name="tra_a" type="number" class="form-control input-sm" placeholder="" value="<?=set_value('tra_a', $info->financing_id)?>">
                  </div>
                  <div class="col-md-6">
                ...
                <div class="row form-row">
                  <div class="col-md-12">
                    ...
                    $more_attr = 'class="form-control input-sm"';
                    echo form_dropdown('financing_id', $financing_list, set_value('financing_id', $info->financing_id), $more_attr);
                    ?>
                  </div>
                </div>               
              </div>
  ...
  function removeRowCcFunc(id){ 
      var dataId = $(id).attr("data-id");
        ...
        if (confirm("আপনি কি এই তথ্যটি ডাটাবেজ থেকে সম্পূর্ণভাবে মুছে ফেলতে চান?") == true) {
          $.ajax({
            type: "POST",
            url: hostname+"training_management/ajax_course_cordinator_del/"+dataId,
