        ...
        <div class="grid simple horizontal green">
          <div class="grid-title">
            ...
            <div class="pull-right">
              <a href="<?=base_url('evaluation/module_exam')?>" class="btn btn-primary btn-xs btn-mini"> মডিউল ভিত্তিক প্রশ্নপত্র তালিকা</a>
            </div>            
            <?php //} ?>
          </div>
                  ...
                  <td>
                    <div class="btn-group pull-right">
                     ...
                     <ul class="dropdown-menu">
                      ...
                      <li><?=anchor("evaluation/examine_answer/$row->eva_id/3/$row->id", 'প্রশ্নপত্র যাচাই ফরম')?></li>
                    </ul>
                  </div> 
                </td>
              </tr>
