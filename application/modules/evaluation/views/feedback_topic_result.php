<div class="page-content">     
  <div class="content">  
    ...
    <style type="text/css">
      ...
      .textLarge {color: black; font-size: 20px;}
              ...
              <div class="col-md-12">
                <table class="tg2">
                  ...
                  foreach ($results as $row) {                     
                    $sl++;
                    $row_count = $this->Training_model->get_feedback_topic_result($row->training_id, $row->id)->row_count;
                    if($row_count){
                    $topic_score = $this->Training_model->get_feedback_topic_result($row->training_id, $row->id)->concept_topic/$row_count;
                    $technique_score = $this->Training_model->get_feedback_topic_result($row->training_id, $row->id)->present_technique/$row_count;
                    $tool_score = $this->Training_model->get_feedback_topic_result($row->training_id, $row->id)->use_tool/$row_count;
                    $time_score = $this->Training_model->get_feedback_topic_result($row->training_id, $row->id)->time_manage/$row_count;
                    $skill_score = $this->Training_model->get_feedback_topic_result($row->training_id, $row->id)->skill/$row_count;
