        ...
        <div class="grid simple horizontal red">
          <div class="grid-title">
            ...
            <div class="pull-right">
              <a href="<?= base_url('evaluation/course_evaluation_participant/' . $info->id) ?>" class="btn btn-primary btn-xs btn-mini"> কোর্স মূল্যায়নের অংশগ্রহণকারীর তালিকা</a>
            </div>
          </div>
          <div class="grid-body">
            ...
            <div class="row">
              <div class="col-md-12">
                <h4><span class="semi-bold"> <em>প্রশিক্ষর্থীর নামঃ</em> <?= $ans->name_bn ?></span></h4>
