      ...
      <div class="col-md-6">
        <div class="grid simple horizontal red">
          ...
          <div class="grid-body">
            ...
            echo form_open_multipart("evaluation/module_exam_create", $attributes);?>
            ...
            <div class="row form-row"> 
              <div class="col-md-6">
                ...
                <select name="training_mark_id" <?=set_value('training_mark_id')?> class="evaluation_val form-control input-sm" >
