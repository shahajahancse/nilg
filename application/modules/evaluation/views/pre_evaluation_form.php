      ...
      <div class="col-md-12">
        <div class="grid simple horizontal red">
          <div class="grid-title">
            ...
            <a href="<?=base_url('evaluation/pre_evaluation_pdf/'.$info->id)?>" class="btn btn-primary btn-xs btn-mini">ডাউনলোড পিডিএফ</a>
            <a href="<?=base_url('evaluation/pre_evaluation_word/'.$info->id)?>" class="btn btn-primary btn-xs btn-mini">ডাউনলোড ওর্য়াড</a>
            <a href="<?=base_url('evaluation/pre_exam')?>" class="btn btn-primary btn-xs btn-mini">প্রশিক্ষণপূর্ব মূল্যায়নের তালিকা</a>
            </div>
          </div>
