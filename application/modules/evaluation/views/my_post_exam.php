        ...
        <div class="grid simple horizontal green">
          <div class="grid-title">
            ...
            <div class="pull-right">
              <!-- <a href="<?= base_url('evaluation/pre_exam_create') ?>" class="btn btn-primary btn-xs btn-mini"> প্রশিক্ষণপূর্ব মূল্যায়নের প্রশ্নপত্র তৈরি করুন</a> -->
            </div>
            <?php //} 
            ?>
          </div>
          ...
          <div class="grid-body" id="refresh_head">
            ...
            <div id="refresh_id" class="table-responsive">
              <table class="table table-hover table-bordered">
                ...
                <tbody>
                  ...
                  foreach ($results as $row): $sl++;
                    // dd(strtotime($row->exam_date .' '. $row->exam_start_time) .' = '. strtotime(date('Y-m-d H:i:s')));
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <?php } else { ?>
                          <?= anchor("evaluation/my_post_exam_form/" . encrypt_url($row->id), 'প্রশ্নপত্র', 'class="btn btn-primary dropdown-toggle btn-mini"') ?>
                        <?php } ?>
                      </td>
                    </tr>
                  <?php endforeach; ?>
