<div class="page-content">     
   <div class="content">  
      <ul class="breadcrumb">
         ...
         <li><a href="<?=base_url('budget/budget_create')?>" class="active"><?=$module_name?></a></li>
         <li><?=$meta_title; ?></li>
      </ul>
            ...
            <div class="grid simple horizontal red">
               <div class="grid-title">
                  ...
                  <div class="pull-right">                
                     <a href="<?=base_url('budget/budget_list')?>" class="btn btn-blueviolet btn-xs btn-mini">রিকুইজিশন তাকিকা</a>  
                  </div>
               </div>
               <div class="grid-body">
