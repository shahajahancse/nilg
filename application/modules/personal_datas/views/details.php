          ...
          <div class="grid-body" id="printableArea">
            <div class="row">
              <style type="text/css">
                ...
                .tg td{font-family: 'Kalpurush', Arial, sans-serif;font-size:14px;padding:5px 5px;border-style:solid;border-width:1px;overflow:hidden;word-break:normal;border-color:#bbb;color:#000000;background-color:#E0FFEB; vertical-align: middle;}
              ...
              <div class="col-md-12">
                <table class="tg" width="100%">
                  ...
                  <tr>
                    ...
                    <td class="tg-ywa9"><?=date_bangla_calender_format($info->date_of_birth); //date('d F, Y', strtotime($info->date_of_birth));?></td>
                  </tr>
                  <tr>
                  ...
                  <tr><td class="tg-mtwr" colspan="4"> দায়িত্বপ্রাপ্ত প্রতিষ্ঠানের তথ্য </td></tr>
                  ...
                  <tr>
                    ...
                    <td class="tg-ywa9"><?=date_bangla_calender_format($info->job_per_date); //date('d F, Y', strtotime($info->job_per_date))?></td>
                    <td class="tg-khup">অবসর উত্তর ছুটিতে গমনের (পিআরএল) তারিখ</td>
                    <td class="tg-ywa9"><?=date_bangla_calender_format($info->retirement_prl_date); //date_format(date_create($info->retirement_prl_date),"d F, Y")?></td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td class="tg-ywa9" colspan="3">
                      ...
                      <table>
                        <tr> 
                          <th>প্রতিষ্ঠানের নাম</th> <th>পদের নাম</th> <th>মেয়াদকাল</th> </tr>
                          <?php foreach ($experience as $exp) { ?>
                          <tr > <td><?=$exp->exp_org_name;?></td> <td><?=$exp->exp_desig_name;?></td> <td><?=$exp->exp_duration;?></td> </tr>
                          <?php } ?>
                        </table>
                    ...
                    <tr>
                      ...
                      <td class="tg-ywa9" colspan="3">
                        ...
                        <table>
                          <tr> 
                            <th>প্রতিষ্ঠানের নাম</th> <th>পদোন্নতি প্রাপ্ত পদবী</th> <th>বেতনক্রম</th> <th> মন্তব্য</th> </tr>
                            <?php foreach ($promotion as $exp) { ?>
                            <tr > <td><?=$exp->promo_org_name;?></td> <td><?=$exp->pro_desig_name;?></td> <td><?=eng2bng($exp->promo_salary_ratio);?></td> <td><?=$exp->promo_comments;?></td></tr>
                            <?php } ?>
                          </table>
                          <?php } ?>
                        </td>
                      ...
                      <td class="tg-ywa9" colspan="3">
                        ...
                        <table>
                          <tr> 
                            <th>ছুটির ধরণ</th> <th>আবেদনের তারিখ </th> <th>হতে </th> <th> পর্যন্ত</th> </tr>
                            <?php foreach ($leave as $lea) { ?>
                            <tr > <td><?=get_leave_type_level($lea->leave_type_id);?></td> <td><?=$lea->leave_app;?></td> <td><?=$lea->leave_from;?></td> <td><?=$lea->leave_to;?></td></tr>
                            <?php } ?>
                          </table>
                          <?php } ?>
                        </td>
                      ...
                      <tr><td class="tg-mtwr" colspan="4"> শিক্ষাগত যোগ্যতা ও প্রশিক্ষণের তথ্য  </td></tr>
                      <tr>
                      ...
                      <tr><td class="tg-mtwr" colspan="4"> এনআইএলজি থেকে প্রাপ্ত প্রশিক্ষণ </td></tr>
                      <tr>
                        <td class="tg-ywa9" colspan="4">
                      ...
                      <tr><td class="tg-mtwr" colspan="4"> দেশে অন্যান্য প্রতিষ্ঠান থেকে প্রাপ্ত প্রশিক্ষণ </td></tr>
                      <tr>
                        <td class="tg-ywa9" colspan="4">
                      ...
                      <tr><td class="tg-mtwr" colspan="4"> বিদেশ থেকে প্রাপ্ত প্রশিক্ষণ </td></tr>
                      <tr>
                        <td class="tg-ywa9" colspan="4">
