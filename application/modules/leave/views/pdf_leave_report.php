...
<body>
  <div class="priview-body">
    ...
    <div class="priview-demand">
      <div class="report_date">রিপোর্ট তারিখ: <?php echo date_bangla_calender_format(date('d-m-Y'));?></div>
      <table class="table table-hover table-bordered report">
        <thead class="headding">
          <tr>  
            <th class="text-center">ক্রম</th>
            <th class="text-center">নাম</th>
            <th class="text-left">ডিপার্টমেন্ট</th>
            <th class="text-left">পদবি</th>                  
            <th class="text-left">ছুটির টাইপ</th>
            <th class="text-left">আরম্ভ তারিখ</th>
            <th class="text-left">সমাপ্তি তারিখ</th>
            <th class="text-left">সময়কাল</th>
          </tr>
        </thead>
        <tbody>
