      ...
      <table class="table table-hover table-bordered report">
        <thead class="headding">
          <tr>
            ...
            <th class="text-center">ছুটির টাইপ</th>
            <th class="text-center">আরম্ভ তারিখ</th>
            <th class="text-center">সমাপ্তি তারিখ</th>
            <th class="text-center">সময়কাল</th>
          </tr>
        </thead>
        <tbody>
          <?php foreach ($results as $key => $row){ ?>
            <tr>
              ...
              <td class="text-center"><?=eng2bng($row->leave_days)?></td>
            </tr>
          <?php } ?>
        </tbody>
      </table>
