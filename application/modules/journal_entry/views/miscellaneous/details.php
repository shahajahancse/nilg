                            ...
                            <div class="col-md-12">
                                <fieldset style="background: #fff !important;">
                                    ...
                                    <div class="row form-row" style="font-size: 16px; color: black; margin-top: -20px !important;">
                                        <br>
                                        <div class="col-md-3">
                                            <strong>ভাউচার নাঃ <span><?= $budget_j_miscellaneous_register->voucher_no ?></span></strong>
                                        </div>
                                        <div class="col-md-3">
                                            <strong>রেফারেন্স: <span><?= $budget_j_miscellaneous_register->reference ?></span></strong>
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-12">
                                           ...
                                           <p><?= $budget_j_miscellaneous_register->description ?></p>
                                        </div>
                                    </div>
                                </fieldset>
                            </div>
