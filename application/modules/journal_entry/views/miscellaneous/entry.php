                ...
                <div class="grid simple horizontal red">
                    ...
                    <div class="grid-body">
                        ...
                        <?php
                            ...
                            echo form_open_multipart("journal_entry/miscellaneous_entry_create",$attributes);
                            ...
                            <div class="col-md-12">
                                <fieldset style="background: #fff !important;">
                                    <div class="col-md-12"
                                        ...
                                        <div>
                                            <span
                                                style="font-size: 22px;font-weight: bold;text-decoration: underline;">বিবিধ তথ্য এন্ট্রি ফর্ম</span>
                                        </div>
                                    </div>
