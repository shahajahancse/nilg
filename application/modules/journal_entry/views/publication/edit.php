                                ...
                                <fieldset style="background: #fff !important;">
                                    ...
                                    <div class="row form-row" style="font-size: 16px; color: black; margin-top: -20px !important;">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="number"  value="<?=$budget_j_publication_register->amount?>" class="form-control input-sm" name="amount"
                                                style="min-height: 33px;" required>
                                        </div>
                                        <div class="col-md-12">
                                            <label for="title" class="control-label">বর্ণনা:</label>
                                            <textarea name="description" id="" style="width: 100%; height: 85px;"><?=$budget_j_publication_register->description?></textarea>
                                        </div>
