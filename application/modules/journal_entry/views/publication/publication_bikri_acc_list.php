                ...
                <div class="grid simple ">
                    <div class="grid-title">
                        ...
                        <div class="pull-right" style="display: flex;align-content: center;justify-content: center;flex-wrap: wrap;gap: 8px;">
                            ...
                            <a href="<?= base_url('journal_entry/publication_bikri_acc_create') ?>" class="btn btn-blueviolet btn-xs btn-mini">এন্ট্রি করুন</a>
                            <?php } ?>
                        </div>
                    </div>
                    <div class="grid-body ">
                                            ...
                                            <td align="right">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu pull-right">
                                                        <li><a href="<?php echo base_url('journal_entry/publication_bikri_acc_details/' . encrypt_url($row->id)) ?>"><i class="fa fa-pencil-square"></i> বিস্তারিত </a></li>

                                                        <li><a href="<?php echo base_url('journal_entry/publication_bikri_acc_print/' . encrypt_url($row->id)) ?>" target="_blank"><i class="fa fa-pencil-square" target="_blank"></i> প্রিন্ট করুন</a></li>

                                                        <?php if ($row->status == 1  && $this->ion_auth->in_group(array('bli'))) { ?>
                                                            <li><a href="<?php echo base_url('journal_entry/publication_bikri_forword/2/' . encrypt_url($row->id)) ?>"><i class="fa fa-pencil-square"></i> ফরওয়ার্ড </a> </li>
                                                        <?php } ?>
                                                        <?php if ($row->status == 2 && $this->ion_auth->in_group(array('bli'))) { ?>
                                                            <li><a href="<?php echo base_url('journal_entry/publication_bikri_forword/1/' . encrypt_url($row->id)) ?>"><i class="fa fa-pencil-square"></i> ব্যাক </a> </li>
                                                        <?php } ?>

                                                        <?php if ($row->status == 2 && $this->ion_auth->in_group(array('acc'))) { ?>
                                                        <li><a href="<?php echo base_url('journal_entry/publication_bikri_forword/3/' . encrypt_url($row->id)) ?>"><i class="fa fa-pencil-square"></i> অ্যাপ্রুভ</a></li>
                                                        <li><a href="<?php echo base_url('journal_entry/publication_bikri_forword/4/' . encrypt_url($row->id)) ?>"><i class="fa fa-pencil-square"></i> বাতিল</a></li>
                                                        <?php } ?>
                                                    </ul>
                                                </div>
                                            </td>
