                ...
                <div class="grid simple ">
                    <div class="grid-title">
                        ...
                        <div class="pull-right" style="display: flex;align-content: center;justify-content: center;flex-wrap: wrap;gap: 8px;">
                            <a href="<?= base_url('journal_entry/pension_from') ?>" class="btn btn-blueviolet btn-xs btn-mini">পেনশন হিসাব</a>
                            <a href="<?= base_url('journal_entry/pension_emp_create') ?>" class="btn btn-blueviolet btn-xs btn-mini">পেনশন কর্মকর্তা/কর্মচারী তৈরি</a>
                        </div>
                    </div>
                            ...
                            <table class="table table-hover table-condensed data_table" border="0">
                                <thead>
                                    <tr>
                                        ...
                                        <th>বৃদ্ধি% </th>
                                        <th style="">চিকিৎসা</th>
                                        <th style="">নীট পেনশন</th>
                                        <th style="">মোট পেনশন</th>
                                        <th style="">ব্যাংক অ্যাকাউন্ট</th>
                                        <!-- <th style="">ব্যাংক ঠিকানা</th> -->
                                        <th style="">অ্যাকশন</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    foreach ($results as $row): $sl++; ?>
                                        <tr>
                                            ...
                                            <td class="v-align-middle"><?= $row->receiver; ?></td>
                                            <td class="v-align-middle"><?= eng2bng($row->basic_salary); ?></td>
                                            <td class="v-align-middle"><?= eng2bng($row->percent); ?></td>
                                            <td class="v-align-middle"><?= eng2bng($row->medical_amt); ?></td>
                                            <td class="v-align-middle"><?= eng2bng($row->nit_amt); ?></td>
                                            <td class="v-align-middle"><?= eng2bng($row->total_amt); ?></td>
                                            <td class="v-align-middle"><?= $row->account; ?></td>
                                            ...
                                            <td align="right">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu pull-right">
                                                        <li><a href="<?php echo base_url('journal_entry/pension_emp_edit/' . encrypt_url($row->id)) ?>"><i class="fa fa-pencil-square"></i> সম্পাদনা করুন </a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
