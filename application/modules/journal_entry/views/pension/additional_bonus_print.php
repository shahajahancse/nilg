...
<body>
    ...
    <div class="priview-body">
        <!-- <div class="priview-demand"> -->
            ...
            <p>বিষয়ঃ প্রতিষ্ঠানের সঞ্চয়ী হিসাব নং (<?= eng2bng($bank_acc) ?>) হতে নিম্নোক্ত <?= eng2bng(count($results)) ?> জন অবসরপ্রাপ্ত কর্মকর্তা ও কর্মচারীর <?= number_bangla_format($month) .'/'. eng2bng($year) ?> ইং বিশেষ ভাতা বাবদ চেক নং- <?= eng2bng($check_no) ?> তারিখঃ <?= eng2bng(date('d/m/Y')) ?> ইং, মোট= <?= eng2bng($bvata) ?>/-( <?= $obj->numToWord($bvata) ?> ) টাকা সরাসরি তাঁর ব্যাংক হিসাব নম্বরে জমাকরণের নির্দেশ পত্র।</p>
            <table class="table table-hover table-bordered report">
                ...
                <tbody>
                    ...
                    <?php $obj = new BanglaNumberToWord(); ?>
                    <tr>
                        <td colspan="4" style="text-align: left; padding-right: 10px"> &nbsp;&nbsp; সর্বমোট : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span> <abbr> <?php echo $obj->numToWord((int)$bvata); ?></abbr> টাকা মাত্র</span></td>
                        <td><?php echo eng2bng($bvata); ?></td>
                    </tr>
                </tbody>
            </table>
        <!-- </div> -->
