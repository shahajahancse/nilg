                ...
                <div class="grid simple ">
                    <div class="grid-title">
                        ...
                        <div class="pull-right"
                            ...
                            <a href="<?= base_url('journal_entry/cheque_entry_create') ?>"
                                class="btn btn-blueviolet btn-xs btn-mini">চেক তৈরি করুণ</a>
                        </div>
                    </div>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu pull-right">
                                                        ...
                                                        <?php if ($row->status == 1 && $this->ion_auth->in_group(array('admin', 'nilg', 'acc'))) { ?>
                                                            <li><a
                                                                    href="<?php echo base_url('journal_entry/chenge_status/cheque/' . encrypt_url($row->id)) ?>"><i
