                ...
                <div class="grid simple horizontal red">
                    ...
                    <div class="grid-body">
                        ...
                        <?php
                            ...
                            echo form_open_multipart("journal_entry/gpf_edit",$attributes);
                                ...
                                <fieldset style="background: #fff !important;">
                                    ...
                                    <div class="row form-row" style="font-size: 16px; color: black; margin-top: -20px !important;">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select required name="user_id" class="form-control input-sm" style="width: 100%; height: 28px !important;">
                                                ...
                                                <?php foreach ($users as $key => $value) { ?>
                                                    <option <?= $value->user_id == $row->user_id ? 'selected' : ''?> value="<?= $value->user_id ?>"><?= $value->name_bn ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                        <div class="col-md-3" >
                                        ...
                                        <div class="col-md-3" >
                                            ...
                                            <input value="<?=$row->pbalance?>" type="number" min="0"  name="pbalance" class="form-control input-sm">
                                                ...
                                                <tbody id="tbody">
                                                    <?php foreach ($details as $key => $value) { ?>
                                                        <tr>
                                                            ...
                                                            <td><input type="number" min="0" value="<?= $value->curr_amt?>" name="curr_amt[]"  class="form-control input-sm curr_amt" style="min-height: 33px;" required onkeyup="getBalance(this)"></td>

                                                            <td><input type="number" min="0"  value="<?= $value->adv_amt?>" name="adv_amt[]" class="form-control input-sm adv_amt" style="min-height: 33px;" required onkeyup="getBalance(this)"></td>
                                                            ...
                                                            <td width="30%" ><input type="" value="<?= $value->description?>"  name="comment[]" class="form-control input-sm comment" style="min-height: 33px;"></td>
                                                        </tr>
                                                    <?php } ?>
                                                    <tr>
                                                        <td width="10%">মোট : </td>
                                                        ...
                                                        <td width="10%"><input type="number" min="0" value="<?= $row->curr_amt + $row->adv_amt ?>" id="total_mot_amt" name="total_mot_amt" class="form-control input-sm" style="min-height: 33px;"   readonly ></td>
