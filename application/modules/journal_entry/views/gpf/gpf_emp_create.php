                ...
                <div class="grid simple horizontal red">
                    ...
                    <div class="grid-body">
                        ...
                        <?php
                            ...
                            echo form_open_multipart("journal_entry/gpf_emp_create",$attributes);
                                ...
                                <fieldset style="background: #fff !important;">
                                    ...
                                    <div class="row form-row" style="font-size: 16px; color: black; margin-top: -20px !important;">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <input class="form-control input-sm" name="account_no" style="min-height: 33px;" required>
                                        </div>
                                        <div class="col-md-2">
                                            <label class="control-label">পূর্ববর্তী পরিমাণ <span style="color:red">*</span> </label>
                                            <input value="0" min="0" id="pre_year_amt" type="number" class="form-control input-sm" name="pre_year_amt" style="min-height: 33px;" required onkeyup="getBalance()" >
                                        </div>
                                        <div class="col-md-2">
                                            <label class="control-label">ঋণের পরিমাণ <span style="color:red">*</span> </label>
                                            <input value="0" min="0" id="loan_amt" type="number" class="form-control input-sm" name="loan_amt" style="min-height: 33px;" required onkeyup="getBalance()">
                                        </div>
                                        <div class="col-md-2">
