                ...
                <div class="grid simple horizontal red">
                    ...
                    <div class="grid-body">
                        ...
                        <?php
                            ...
                            echo form_open_multipart("journal_entry/bank_entry_create",$attributes);
                            ...
                            <div class="col-md-12">
                                <fieldset style="background: #fff !important;">
                                    ...
                                    <div class="row form-row" style="font-size: 16px; color: black; margin-top: -20px !important;">
                                        <br>
                                        <div class="col-md-2">
                                            <label for="title" class="control-label">ব্যাংক   নাঃ </label>
                                            <input type="text"  value="" class="form-control input-sm" name="bank_no"
