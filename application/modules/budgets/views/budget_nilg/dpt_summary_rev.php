                                            ...
                                            <td align="right">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu pull-right">
                                                        <li> <a href="<?php echo base_url('budgets/dpt_summary_rev_details/' . encrypt_url($row->id)) ?>"   target="_blank"> <i class="fa fa-pencil-square"></i> বিস্তারিত </a> </li>

                                                        <li> <a href="<?php echo base_url('budgets/dpt_summary_rev_details_print/' . encrypt_url($row->id)) ?>"   target="_blank"> <i class="fa fa-pencil-square"></i> প্রিন্ট করুন </a> </li>
                                                        <li> <a href="<?= base_url('budgets/dpt_summary_rev_rajossho_entry/' . encrypt_url($row->id)) ?>"> <i class="fa fa-pencil-square"></i> রাজস্ব টাকা সংযুক্ত করুন</a> </li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
