                ...
                <div class="grid simple horizontal red">
                    <div class="grid-title">
                        ...
                        <div class="pull-right">
                            <a href="<?= base_url('budgets/revenue_summary') ?>" class="btn btn-blueviolet btn-xs btn-mini">সামারী তাকিকা</a>
                        </div>
                    </div>
                    <div class="grid-body">
                        ...
                        echo form_open_multipart("budgets/acc_summary_create", $attributes);
