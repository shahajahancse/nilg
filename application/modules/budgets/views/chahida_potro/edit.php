            ...
            <div class="col-md-12">
                <div class="grid simple horizontal red">
                    ...
                    <div class="grid-body">
                        ...
                        echo form_open_multipart("budgets/budget_chahida_potro_edit",$attributes);
                        echo validation_errors();
                        ?>
                        <input type="hidden" name="id" value="<?=$chahida_potro->id?>">
                        <input type="hidden" name="created_by" value="<?=$chahida_potro->created_by?>">
                                    ...
                                    <div class="row form-row" style="font-size: 16px; color: black;">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control input-sm" name="title"
                                                style="min-height: 33px;" value="<?=$chahida_potro->title?>" required>
                                        </div>
                                    </div>
