...
class Qbank extends Backend_Controller {
    ...
    public function index($offset=0){        
        ...
        //pagination
        $this->data['pagination'] = create_pagination('qbank/index/', $this->data['total_rows'], $limit, 3, $full_tag_wrap = true);
    ...
    public function add(){
        ...
        $this->form_validation->set_rules('question', 'প্রশ্ন', 'required|trim');
    ...
    function ajax_question_by_id($id){
        ...
        $this->load->view('ajax_question_details', $this->data);
    }
