                ...
                if ($all_list > 0) { //print_r($all_list);exit;
                  foreach ($all_list as $row) {  ?>
                    ...
                    <tr>
                      ...
                      <td>
                        <a class="btn btn-mini default" href="<?php echo base_url(); ?><?= $this->uri->segment(1); ?>/view?id=<?php echo $row['id']; ?>"> <i class="fa fa-pencil-square"></i> <?php echo lang('stu_clas_View'); ?> </a>

                        <a class="btn btn-mini default" href="<?php echo base_url(); ?><?= $this->uri->segment(1); ?>/edit?id=<?php echo $row['id']; ?>"> <i class="fa fa-pencil-square"></i> <?php echo lang('stu_clas_Edit'); ?> </a>

                        <a class="btn btn-mini" href="<?php echo base_url(); ?><?= $this->uri->segment(1); ?>/delete?id=<?php echo $row['id']; ?>" onClick="javascript:return confirm('Are you sure you want to delete this record?')" style="color: red;"> <i class="fa fa-trash-o"></i> <?php echo lang('stu_clas_Delete'); ?> </a>
                      </td>
                    </tr>
                  <?php }
                } else { ?>
