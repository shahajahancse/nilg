...
class Setup_con extends CI_Controller {
	...
	function member()
	{
		...
		$this->grocery_crud->set_relation('mem_type','member_type','mem_name');
		$this->grocery_crud->set_subject('Member Setup');
		$this->grocery_crud->set_relation('designation','lib_designation','designation');
		$this->grocery_crud->set_relation('level','member_group','group_name');
	...
	function journal_set()
	{
		...
		$this->grocery_crud->display_as('acc_first','Acc. No. First')->display_as('acc_last','Acc. No. Last')->display_as('date_of_entry','Date of Entry')->display_as('call_no','Call No')->display_as('issn','ISSN')->display_as('trans_co_author','Author')->display_as('first_subject','1st Subject')->display_as('snd_subject','2nd Subject')->display_as('thrd_subject','3rd Subject')->display_as('forth_subject','4th Subject')->display_as('fifth_subject','5th Subject')->display_as('y_of_pub','Year of Pub.')->display_as('initial_page','Initial Page')->display_as('total_page','Total Page')->display_as('cd','CD');
