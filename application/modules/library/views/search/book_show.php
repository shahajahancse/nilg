...
<td width='70%' style='border:0;'>
		<a  style="text-decoration:none; color:#512828" href='<?php echo base_url();?>index.php/search_con/book_details/<?php echo $isbn[$i];?>'><div  style='width:100%;height:auto; font-size: 19px;'><?php echo $title[$i];?></div>
