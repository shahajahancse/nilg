...
?>
	...
	<div style="width:650px; height: auto; margin:0 auto; overflow:hidden;">
			...
			<div style="width:460px; height:auto; float:left;padding:10px; border-radius:7px; border:1px solid #2F5E5E;">
...
<?php //echo $value["publisher"];?> </div>
			...
			?>
			<div style="width:auto; height:auto; float:left; position:relative; left:20px;">
