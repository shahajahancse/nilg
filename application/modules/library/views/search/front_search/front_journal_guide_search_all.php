...
<form  name='search_book' action="<?php echo base_url(); ?>index.php/library/journal_guided_search_view_all"  method="post">
		<table width="330" border="0" cellpadding="3"  align="center" style="border-collapse:collapse; font-size:15px; font-family:arial;">
			...
			<td width="219"> <input type="text"  name="trans_co_author" size="30" value="<?php if (isset($_POST['trans_co_author'])){echo $_POST['trans_co_author'];} else{ echo "";} ?>" /></td>
			</tr>
			...
			<tr>
			<td width="167">ISSN</td><td>:</td>
			<td width="219"> <input type="text"  name="issn" size="30" value="<?php if (isset($_POST['issn'])){echo $_POST['issn'];} else{ echo "";} ?>" /></td>
			</tr>
