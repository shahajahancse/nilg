...
<body>
	<div style="height:auto; margin:0 auto; width:95%; margin-top:20px;">
		<div style="text-align:center; font-family:Arial; font-size:18px; font-weight:bold; margin-bottom:10px;">
			<?php if ($search_type == "keywords") {
				echo "Keywords Search";
			} else {
				echo "Guided Search";
			} ?>
		</div>
		<div style="width:110px; float:left; font-weight:bold; font-family:arial;">Total Results: </div>
		<div style="color:#19A751; width:50px; float:left;"><?php echo $num_rows1; ?> </div>
