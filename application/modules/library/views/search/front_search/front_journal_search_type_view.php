...
<div align="center" style="margin:0 auto; width:657px; overflow:hidden; min-height:400px; ">
	...
	<form  name='search_type' action="<?php echo base_url(); ?>index.php/library/journal_keywords_search_view_all"  method="post">
		<div style="width:53%; height:auto; background: #E6EED5; padding:5px;border-radius:5px; margin-top:3px;">
		  <table width="500" border="0" cellpadding="3"  align="center" style="font-size:15px;">
			<tr>
            <td colspan="3" style="font-size:21px; font-weight:bold; text-align:center; height:45px;">Journal Search</td>
            </tr>
			<tr>
			...
			<tr>
				...
				<td><a href="<?php echo base_url(); ?>index.php/library/journal_guided_search"><input type="button" value="Guided Search" style="border-radius:5px;border:2px solid #8FCD99;background:#BEF3CC; width:150px;cursor:pointer"/></a></td>
			</tr>
			 </table>
		</div>
		</form>
	...
	<?php if(isset($guide_search)){ ?>
		...
		<?php $this->load->view('search/front_search/front_journal_guide_search_all'); ?>
