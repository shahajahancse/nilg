...
<?php //echo $value["publisher"];?> </div>
			...
			<tr >
			<td style="font-size: 18px; font-weight:bold;">ISSN</td><td style="font-size: 17px; font-weight:bold;">:</td>
			...
			<FIELDSET>
			<LEGEND style="color:#19A751; font-size:17px"><b>Journal Status</b></LEGEND>
			<table >
			...
			<tr>
			<td style="font-size: 17px; font-weight:bold;">No. of Journals Requesting</td><td style="font-size: 17px; font-weight:bold;">:</td>
			...
			<tr>
			<td style="font-size: 17px; font-weight:bold;">No. of Journals Issued</td><td style="font-size: 17px; font-weight:bold;">:</td>
			<td><?php echo $issued ;?></td>
			</tr>
			
			<tr>
			<td style="font-size: 17px; font-weight:bold;">Available Journals</td><td style="font-size: 17px; font-weight:bold;">:</td>
