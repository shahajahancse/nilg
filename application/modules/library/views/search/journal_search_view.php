...
<?PHP
  ...
  else if ($selected_radio == 'trans_co_author') {
  $trans_co_author = 'checked';
  }
      ...
      <div class="grid-body tableresponsive">
        <div align="center" style="margin:0 auto; width:100%; overflow:hidden; ">
          <fieldset style='border:3px #004040 solid; padding:10px;border-radius:5px;'>
            <legend><font size='+1'><b>Search Keys</b></font></legend>
            <form  name='search_book' action="<?php echo base_url(); ?>library/search_con/journal_search_view"  method="post">
              <table width='100%' border='0' align='center' style='padding:10px; color:#285151; font-weight:bold; font-size:13px;'>
                <tr>
                <td><input type="radio" name="radioValue" value="issn" checked id="issn" <?PHP print $issn; ?>/>Search By ISSN</td>
                ...
                <td width="38%"><input type="radio" name="radioValue" value="volume" id="volume" <?PHP print $volume; ?> required/>Search By Volume</td>
                </tr>
                <tr>
                ...
                <td><input type="radio" name="radioValue" value="cd" id="cd" <?PHP print $cd; ?>/>Search  By CD </td>
                <td><input type="radio" name="radioValue" value="trans_co_author" id="trans_co_author" <?PHP print $trans_co_author; ?> required/>Search Author </td>
                </tr>
