...
<a  href="javascript: history.go(-1)" style="text-decoration:none;"><input class="submit" type="button" value="Back" ></a>
...
<?php $image =  $value["image"];
	...
	<div style="width:650px; height: auto; margin:0 auto; overflow:hidden;">
			...
			<div style="width:490px; height:auto; float:left;padding:10; border-radius:7px; border:3px solid #2F5E5E;">
...
<?php //echo $value["publisher"];?> </div>-->
	...
	<!--<input type="image" src='<?php echo base_url();?>uploads/request.png' width="100" height="25" onClick="for_booking()">/>-->
