...
<html xmlns="http://www.w3.org/1999/xhtml"><head id="Head1"><title>
    ...
    <frameset rows="60,*,20">
        ...
        <frame id="footer" src="<?php echo base_url();?>index.php/payroll_con/footer" name="bottomFrame" noresize="noresize" framespacing="0" frameborder="NO" border="0" scrolling="NO">
