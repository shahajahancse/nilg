       ...
       <div class="col-md-10">
          <div class="grid simple horizontal red">
             ...
             <div class="grid-body">
              ...
              echo form_open_multipart("organizations/add", $attributes);?>
                ...
                <div class="col-md-4">
                  <div class="form-group">
					         <label class="form-label">জেলা</label>
          					...
          					<?php
                      $more_attr = 'class="form-control input-sm select2" id="distirict"';
                      echo form_dropdown('org_dis_id', $districts, set_value('org_dis_id', $this->input->post('org_dis_id')), $more_attr);
                    ?>
                    </div>
				        </div>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <?php
                      ...
                      echo form_dropdown('org_type_id', $organization_type, set_value('org_type_id', $this->input->post('org_type_id')), $more_attr);
                      ?>
                  </div>
                </div>
              </div>
              ...
              <div class="row form-row">
                <div class="col-md-8">
                  ...
                  <input name="org_name" id="org_name" type="text" class="form-control input-sm" placeholder="ইউনিয়ন, জেলা, উপজেলা, সিটি কর্পোরেশন" value="<?=set_value('org_name')?>">
                </div>
