        ...
        <div class="grid simple horizontal red">
          <div class="grid-title">
            ...
            <div class="pull-right">
              <a href="<?=base_url('training_management/pdf_feedback_course/'.$info->id)?>" class="btn btn-primary btn-mini" target="_blank"> কোর্স মূল্যায়ন পিডিএফ</a>
            ...
            <div class="row">
              <div class="col-md-12" style="text-align: center;">
                ...
                <span style="color: black; font-weight: bold;">
                  ...
                  $result = $this->Training_management_model->get_feedback_course_result($info->id);
                  ?>
                </span>
              </div>     
            </div>
