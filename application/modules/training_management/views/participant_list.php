        ...
        <div class="grid simple horizontal red">
          <div class="grid-title">
            ...
            <div class="pull-right">
              ...
              <a href="<?= base_url('training_management/pdf_attendance_no/' . $info->id) ?>" class="btn btn-primary btn-mini" target="_blank"> দৈনিক হাজিরা সীটের পিডিএফ (নম্বর)</a>
              ...
              <div class="col-md-12">
                ...
                <div class="row form-row">
                  <div class="col-md-6">
                    ...
                    <select class="nationalIDselect2 form-control input-sm" name="national_id" style="width: 100%;" id="national_id"'></select>
