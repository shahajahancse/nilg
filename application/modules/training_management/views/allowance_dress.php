        ...
        <div class="grid simple horizontal red">
          <div class="grid-title">
            ...
            <div class="pull-right">
              <a href="<?=base_url('training_management/pdf_allowance_dress/'.$training->id)?>" class="btn btn-primary btn-mini" target="_blank"> পোষাক ভাতার পিডিএফ</a>
                  ...
                  <div class="col-md-12">
                    ...
                    <table class="tg2">
                      <tr>
                        ...
                        <td class="tg-71hr text-center">পোষাক ভাতা</td>
                        <?php }?>
                      </tr>
                      <?php 
                      $i=0;                        
