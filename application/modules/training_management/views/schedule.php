        ...
        <div class="grid simple horizontal red">
          <div class="grid-title">
            ...
            <div class="pull-right">
              ...
              <a href="<?= base_url('training_management/pdf_schedule/' . $info->id) ?>" class="btn btn-primary btn-mini" target="_blank"> প্রশিক্ষণ কর্মসূচীর পিডিএফ</a>
              ...
              <div class="col-md-12">
                ...
                <div class="row form-row">
                  ...
                  <div class="col-md-5">
                    ...
                    <select class="traineeSelect2 form-control input-sm" name="trainer_id" style="width: 100%;" id="trainer_id"'></select>
                  </div>               
                </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <!-- <?php echo $info->id; ?> -->
                    <form method="post" action="<?php echo base_url('training_management/schedule_date_range_search'); ?>">
                        ...
                        <div class="col-md-2">
                            ...
                            <input name="start_date" type="text" class="form-control input-sm datetime" placeholder="">
                        </div>
                        <div class="col-md-2">
                            <label class="form-label">শেষের তারিখ <span class="required">*</span></label>
                            <?php echo form_error('start_date'); ?>
                            <input name="end_date" type="text" class="form-control input-sm datetime" placeholder="">
                        </div>
                        <div class="col-md-2">  
                            <label class="form-label">&nbsp;</label>
