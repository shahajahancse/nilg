        ...
        <div class="grid simple horizontal red">
          <div class="grid-title">
            ...
            <div class="pull-right">
              <a href="<?= base_url('training_management/pdf_attendance/' . $info->id) ?>" class="btn btn-primary btn-mini" target="_blank"> দৈনিক হাজিরা সীটের পিডিএফ</a>
                    ...
                    <table class="tg2">
                      ...
                      ?>
                        <tr>
                          ...
                          <td class="tg-031e"><?= $row->name_bangla ?></td>
                          <td class="tg-031e"><?= $row->national_id ?></td>
                          <td class="tg-031e"><?= $row->desig_name ?></td>
                          <td class="tg-031e"><?= $row->telephone_mobile ?></td>
                          <td class="tg-031e"><?= $row->is_complete == 1 ? anchor("training_management/pdf_certificate/" . $row->id, 'সার্টিফিকেট', array('class' => 'btn btn-primary btn-mini', 'target' => '_blank')) : 'Not Yet' ?> </td>
                        </tr>
                      <?php } ?>
                    </table>
                  </div>
