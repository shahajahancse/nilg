...
<body>
	<div class="priview-body">
		...
		<div class="priview-memorandum">
			<div class="row">
				<div class="col-md-12" style="text-align: center;">
					<span style="color: black; font-size: 16px; font-weight: bold;"><?=$training->participant_name?> এর "<?=$training->course_title?>" (ব্যাচ নং <?=eng2bng($training->batch_no)?>)</span> <br>
		...
		<div class="priview-memorandum">
			<div class="row">
				<div class="col-md-12" style="text-align: left;">
					<strong><?=$training->participant_name?> এর "<?=$training->course_title?>" </strong> এর আলোচক / কোর্স উপদেষ্টা / মডারেটর /  কোর্স পরিচালক / কোর্স সমন্বয়ক / র‍্যাপটিয়ার হিসেবে সম্মানী ধন্যবাদের সাথে গৃহীত হলো।
				</div>     
			</div>
		</div>
		...
		<div class="priview-demand">
			<table class="table table-hover table-bordered report">
				<thead class="headding">
					<tr>
						<td class="text-center">সম্মানীর পরিমান</td>
						<td class="text-center">আইটি কর্তন (১০%)</td>
						<td class="text-center">নিট প্রদেয়</td>
					</tr>
				</thead>

				<tbody>
					<?php 					
					$deduction = ($schedule->honorarium*10)/100;
					$payable = $schedule->honorarium-$deduction;
					?>
					<tr>
						<td class="text-center"><?=eng2bng($schedule->honorarium)?></td>
						<td class="text-center"><?=eng2bng($deduction)?></td>
						<td class="text-center"><?=eng2bng($payable)?></td>
					</tr>
				</tbody>
			</table>			
		</div>
		...
		<div class="signature">
			স্বাক্ষরঃ <br><br><br><br>
			নামঃ <strong><?=$schedule->trainer_name?></strong><br>
			পদবীঃ <?=$schedule->trainer_desig?></strong><br>
			প্রতিষ্ঠানঃ <?=$schedule->trainer_org_name?><br>
		</div>
	</div>
