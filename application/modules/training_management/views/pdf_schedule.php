		...
		<div class="priview-demand">
			<table class="table table-hover table-bordered report">
				<thead class="headding">
					<tr>
						<td class="text-center" width="100">তারিখ</td>
						<td class="text-center" width="120">সময়</td>
						<td class="text-center" width="50">অধি. নং</td>
						<td class="text-center">আলোচনার বিষয়</td>
						<td class="text-left" width="180">আলোচক/সহায়ক/ দায়িত্ব প্রাপ্ত কর্মকর্তা</td>
					</tr>
				</thead>
				...
				<tbody>
					...
					foreach ($results as $row) { 
						...
						<tr style="line-height: 100px;">
							...
							<td class="text-left" colspan="3"><?=$row->topic?></td>
							<?php }else{ ?>
