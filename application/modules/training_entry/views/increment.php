          ...
          <div class="grid-body">
            ...
            <tbody> -->
                ...
                <td class="v-align-middle"><? //$sl.'.'
                                            ?></td>
                <td class="v-align-middle"><strong><span class="trigger-scout-id"><? //$row->employee_id
                                                                                  ?> </span></strong>
                  <td class="v-align-middle"><? //$row->full_name;
                                              ?></td>
                  <td class="v-align-middle"><strong><? //$row->basic_salary
                                                      ?></strong></td>
                  <td class="v-align-middle"><? // $row->designation_name
                                              ?></td>
                  <td class="v-align-middle"><span class="label label-green"><? //$row->grade_name;
                                                                              ?></span></td>
                  <td class="v-align-middle"><? //$row->office_name_bng
                                              ?></td>
                  <td class="v-align-middle"><? //$row->mobile_no
                                              ?></td>
                </tr>
                <?php //endforeach;
                ?>                      
