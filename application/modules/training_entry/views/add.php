            ...
            if($info) { 
              ...
              <div class="scout-verify-box">
               ...
               <style type="text/css">
                ...
                .tg2 td{font-family:Arial, sans-serif;font-size:14px;padding:5px;border-style:solid;border-width:1px;overflow:hidden;word-break:normal;border-color:black;}
                .tg2 th{font-family:Arial, sans-serif;font-size:14px;font-weight:normal;padding: 5px;border-style:solid;border-width:1px;overflow:hidden;word-break:normal;border-color:black;}
                .tg2 .tg-yfmt{background-color:#cbcefb;border-color:inherit}
                .tg2 .tg-l711{border-color:inherit}
                .tg2 .tg-us36{border-color:inherit;vertical-align:top}
                .tg2 .tg-qkv2{background-color:#cbcefb;border-color:inherit;vertical-align:top}
              </style>
              <table class="tg2">
                <tr>
