					...
					<?php 
						...
						foreach ($results as $row) { 
							...
							<tr style="line-height: 100px;">
								...
								<td class="tg-031e" align="center"><?php if($totalDAD != '0'){ echo eng2bng($row->totalDAD); }?></td>
								<td class="tg-031e" align="center"><?php if($totalDAD != '0'){ echo eng2bng($row->it_deduction); }?></td>
								<td class="tg-031e" align="center"><?php if($totalDAD != '0'){ echo eng2bng($totalDAD); }?></td>
