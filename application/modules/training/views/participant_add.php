              ...
              <div class="col-md-12">
                ...
                <div class="row form-row">
                  ...
                  <div class="col-md-3">
                    ...
                    <input name="so" type="number" class="form-control input-sm" placeholder="" value="<?=set_value('so')?>">
                  </div>
                ...
                <input type="hidden" name="hide_course_id" id="hide_course_id" value="<?=$training->course_id?>">              
                <?php echo form_close();?>
