          ...
          <div class="grid-body">
            ...
            <div class="row form-row">
              <div class="col-md-3">
                ...
                <input type="text" onchange="getDays()" class="form-control datetime input-sm font-opensans" name="start_date" id="start_date" autocomplete="off" value="<?php echo date('Y-m-d') ?>">
              </div>

              <div class="col-md-3">
                <label class="form-label font-opensans">শেষের তারিখ <span class="required">*</span></label>
                <?php echo form_error('end_date'); ?>                
                <input type="text" onchange="getDays()" class="form-control datetime input-sm font-opensans" name="end_date" id="end_date" autocomplete="off" value="<?php echo date('Y-m-d') ?>">
              </div>

              <div class="col-md-2">
                <label class="form-label font-opensans">দিন<span class="required"></span></label>
                <?php echo form_error('days'); ?>                
                <input type="number" class="form-control input-sm font-opensans" name="days" id="days" readonly value="1">
              </div>
              <div class="col-md-2">
                <label class="form-label font-opensans">প্রশিক্ষণ ভাতা<span class="required">*</span></label>
                <?php echo form_error('amount'); ?>                
                <input type="number" class="form-control input-sm font-opensans" name="amount" id="amount" value="">
              </div>
              <div class="col-md-2">
                <label class="form-label font-opensans">মোট ভাতা<span class="required"></span></label>
                <?php echo form_error('new_confirm'); ?>                
                <input type="text" class="form-control input-sm font-opensans" name="total_amount" readonly value="0" id="total_amount">
              </div>
