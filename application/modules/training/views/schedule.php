              ...
              <div class="col-md-12">
                ...
                <form method="get" action="<?php //echo base_url('training/schedule_date_range_search'); 
                  ...
                  <div class="col-md-2">
                    ...
                    <input name="start_date" type="text" class="form-control input-sm datetime" autocomplete="off" value="<?php if (isset($start_date)) {
                                                                                                                            echo $start_date;
                  ...
                  <div class="col-md-2">
                    ...
                    <input name="end_date" type="text" class="form-control input-sm datetime" autocomplete="off" value="<?php if (isset($end_date)) {
                                                                                                                          echo $end_date;
                                                                                                                        } ?>" required>
                  </div>
                  <div class="col-md-2">
