...
<body>
	<div class="priview-body">
		...
		<div class="priview-memorandum">
			<div class="row">
				<div class="col-md-12" height="180" width="100%" style="background: 
				url(<?=base_url('awedget/assets/img/nilg-certificate.png')?>); background-image-resolution: 500dpi; background-repeat: no-repeat; background-position: center; border: 0mm solid black; text-align: justify; padding-top: 50px; inline-line-height: 3em;">
				<span style="font-size: 25; line-height: 25px; margin-top: 0px; display: block;"> 
					<strong>জনাব <?=$info->name_bn?>, <?=$info->desig_name?>, 
						...
						<?php }elseif($info->office_type == 4 || $info->data_sheet_type == 5){ ?> 
