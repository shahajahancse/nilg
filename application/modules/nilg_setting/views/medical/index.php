                ...
                <div class="grid simple ">
                    <div class="grid-title">
                        ...
                        <div class="pull-right" style="display: flex;align-content: center;justify-content: center;flex-wrap: wrap;gap: 8px;">
                            <a href="<?= base_url('nilg_setting/medical_create') ?>" class="btn btn-blueviolet btn-xs btn-mini">নতুন তৈরি করুন</a>
                        </div>
                    </div>
                                        ...
                                        <td align="right">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu pull-right">
                                                    <li>
                                                        <a href="<?php echo base_url('nilg_setting/medical_edit/' . encrypt_url($row->id)) ?>"><i class="fa fa-pencil-square"></i> সংশোধন করুন </a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>
