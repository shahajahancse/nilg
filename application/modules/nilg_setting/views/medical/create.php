...
<div class="page-content">
    <div class="content">
        <ul class="breadcrumb">
            ...
            <li><a href="<?=base_url('nilg_setting/medical')?>" class="active"><?=$module_name?></a></li>
            <li><?=$meta_title; ?></li>
        </ul>
                ...
                <div class="grid simple horizontal red">
                    <div class="grid-title">
                        ...
                        <div class="pull-right">
                            <a href="<?=base_url('nilg_setting/medical')?>" class="btn btn-blueviolet btn-xs btn-mini">চিকিৎসা ভাতা তালিকা</a>
                        </div>
                    </div>
                    <div class="grid-body">
                        ...
                        <?php
                            ...
                            echo form_open_multipart("nilg_setting/medical_create",$attributes);
                            echo validation_errors();
                        ?>
                        <div class="row">
                            <div class="col-md-12">
                                <fieldset style="background: #fff !important;">
                                    <legend>চিকিৎসা ভাতা তথ্য</legend>
