                ...
                <div class="grid simple horizontal red">
                    ...
                    <div class="grid-body">
                        ...
                        <?php
                            ...
                            echo form_open_multipart("nilg_setting/bank_account_create",$attributes);
                                ...
                                <fieldset style="background: #fff !important;">
                                    ...
                                    <div class="row form-row" style="font-size: 16px; color: black; margin-top: -20px !important;">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input required type="text" name="account_no" class="form-control input-sm">
                                        </div>
                                        <div class="col-md-5">
                                            <label for="title" class="control-label">ঠিকানা (বাংলা): <span class="required">*</span></label>
                                            <textarea required name="address_bn" class="form-control input-sm"></textarea>
                                        </div>
                                        <div class="col-md-5">
                                            <label for="title" class="control-label">ঠিকানা (ইংরেজী): <span class="required">*</span></label>
                                            <textarea required name="address_en" class="form-control input-sm"></textarea>
                                        </div>
                                        <div class="col-md-2">
                                            <label for="title" class="control-label">টাইপ:</label>
                                            <select name="type" class="form-control input-sm" >
                                                <option value="1">Nilg</option>
