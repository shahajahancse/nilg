        ...
        <div class="grid simple horizontal green">
          <div class="grid-title">
            ...
            <div class="pull-right">
              ...
              <a href="<?= base_url('nilg_setting/budget_sub_head/add') ?>" class="btn btn-primary btn-xs btn-mini"> এন্ট্রি করুন</a>
            </div>
          </div>
                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <ul class="dropdown-menu pull-right">
                          <li><a href="<?= base_url('nilg_setting/budget_sub_head/edit/' . $row->id); ?>">সংশোধন</a></li>
                          <?php if ($this->ion_auth->is_admin()) { ?>
                            <li class="divider"></li>
                            <li><a href="<?= base_url("nilg_setting/budget_sub_head/delete/" . $row->id) ?>" onclick="return confirm('Be careful! Are you sure you want to delete this data?');">মুছে ফেলুন </a></li>
                          <?php } ?>
                        </ul>
                      </div>
                    </td>
