    ...
    <div class="col-md-12">
        <div class="grid simple horizontal red">
          ...
          <div class="grid-body">
            ...
            echo form_open_multipart("nilg_setting/training_material/add", $attributes);?>
            ...
            <div class="row form-row">
              <div class="col-md-6">
                ...
                <input name="material_name" type="text" class="form-control input-sm" placeholder="" value="<?=set_value('material_name')?>">
              </div>
              ...
              <!-- <div class="col-md-3">
                ...
                <input name="course_duration" type="text" class="form-control input-sm" placeholder="" value="<?php //set_value('course_duration')?>">
              </div> -->
              */ ?>
            </div>
