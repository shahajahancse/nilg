          ...
          <div class="grid-body">
            ...
            <div class="row form-row">
              <div class="col-md-3">
                ...
                echo form_dropdown('org_type', $org_type, set_value('org_type', $info->org_type), $more_attr);
                ?>
              </div>
            </div>
            ...
            <div class="row form-row">            
              <div class="col-md-6">
                ...
                <input name="partner_name_full_bn" type="text" class="form-control input-sm" placeholder="উদাঃ চেয়ারম্যান" value="<?=set_value('partner_name_full_bn', $info->partner_name_full_bn)?>">
              </div>

              <div class="col-md-6">
                <label class="form-label">সংস্থার সংক্ষিপ্ত নাম (বাংলা)</label>
                <?php echo form_error('partner_name_short_bn'); ?>
                <input name="partner_name_short_bn" type="text" class="form-control input-sm" placeholder="উদাঃ চেয়ারম্যান" value="<?=set_value('partner_name_short_bn', $info->partner_name_short_bn)?>">
              </div>
            </div>
            <br>
            ...
            <div class="row form-row">            
              <div class="col-md-6">
                ...
                <input name="partner_name_full_en" type="text" class="form-control input-sm" placeholder="উদাঃ চেয়ারম্যান" value="<?=set_value('partner_name_full_en', $info->partner_name_full_en)?>">
              </div>

              <div class="col-md-6">
                <label class="form-label">সংস্থার সংক্ষিপ্ত নাম (ইংরেজি)</label>
                <?php echo form_error('partner_name_short_en'); ?>
                <input name="partner_name_short_en" type="text" class="form-control input-sm" placeholder="উদাঃ চেয়ারম্যান" value="<?=set_value('partner_name_short_en', $info->partner_name_short_en)?>">
              </div>
            </div>
