...
<head>
  ...
  <style type="text/css">
    ...
    .priview-memorandum{text-align:center; font-size: 18px;}
      ...
      <table class="table table-bordered ">
        ...
        <tbody>
          ...
          foreach ($results as $row){
            $sl++; $answer = $row->answer != NULL?"<span class='label label-success'>হ্যাঁ</span>":"<span class='label label-danger'>না</span>"; ?>
            <tr>
              <td><?=eng2bng($sl).'.'?></td>
