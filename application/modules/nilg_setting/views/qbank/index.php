                    ...
                    <td>
                      <div class="btn-group"> 
                        ...
                        <ul class="dropdown-menu pull-right">
                          <li><a href="<?=base_url('nilg_setting/qbank/edit/'.$row->id);?>">সংশোধন</a></li>
                          <li><a href="<?=base_url('nilg_setting/qbank/details/'.$row->id);?>">বিস্তারিত</a></li>
                          <?php if($this->ion_auth->is_admin()){ ?> 
                          <li class="divider"></li>
                          <li><a href="<?=base_url("nilg_setting/qbank/delete/".$row->id)?>" onclick="return confirm('Be careful! Are you sure you want to delete this data?');">মুছে ফেলুন </a></li>
                          <?php } ?>
                        </ul>
                      </div>
                    </td>
          ...
          $.ajax({
            ...
            success: function (response) {
              ...
              if (response.status == 1) {
                ...
                window.location = "<?php echo base_url()?>nilg_setting/qbank";
              } else {
