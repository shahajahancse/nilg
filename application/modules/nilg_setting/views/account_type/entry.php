                ...
                <div class="grid simple horizontal red">
                    ...
                    <div class="grid-body">
                        ...
                        <?php
                            ...
                            echo form_open_multipart("nilg_setting/account_type_create",$attributes);
                                ...
                                <fieldset style="background: #fff !important;">
                                    ...
                                    <div class="row form-row" style="font-size: 16px; color: black; margin-top: -20px !important;">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <input class="form-control input-sm" name="name_bn" style="min-height: 33px;">
                                        </div>
                                        <div class="col-md-5">
                                            <label for="title" class="control-label">নাম টাইপ (ইংরেজী):</label>
                                            <input class="form-control input-sm" name="name_en" style="min-height: 33px;">
                                        </div>
                                        <div class="col-md-2">
