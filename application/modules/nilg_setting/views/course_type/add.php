    ...
    <div class="col-md-12">
        <div class="grid simple horizontal red">
          ...
          <div class="grid-body">
            ...
            echo form_open_multipart("nilg_setting/course_type/add", $attributes);?>
            ...
            <div class="row form-row">
              <div class="col-md-6">
                ...
                <input name="ct_name" type="text" class="form-control input-sm" placeholder="" value="<?=set_value('ct_name')?>">
              </div>
            </div>
