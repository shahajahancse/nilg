          ...
          <div class="grid-body">
            ...
            <div class="row form-row">   
              <div class="col-md-6 p5">
                  ...
                  <input name="title" class="form-control input-sm"  value="<?=set_value('title')?>" />
              </div>
            ...
            <div class="row form-row">            
              <div class="col-md-12 p5">
                <div class="form-group">
                  ...
                  <textarea name="details" class="form-control input-sm" id="description"  cols="30" rows="10"></textarea>
                </div>
              </div>
            </div>
