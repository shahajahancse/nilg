...
define('ROOT_UPLOAD_PATH', BASH_PATH . 'uploads/temp_dir/');
define('HTTP_USER_PROFILE_THUMB_PATH', $constants['base_url'] . 'uploads/temp_dir/_thumb/');
...
define('APPLICATION_NAME', 'bdquery');
